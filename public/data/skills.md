...
## Adopt
### Skills I use regularly and with high confidence without Vibe code. These define my daily work and expertise.
Python | FastAPI | Microservices ,Expert,15+,Python
SQL | NoSQL | Distributed DBs | Transactional DBs ,Expert,15+,SQL
AWS Services | Most of the Services,Expert,10+,AWS
Snowflake,Advanced,5+,Snowflake
DBT,Expert,5+,DBT
Apache Spark | Batch & Realtime,Advanced,10+,Spark
Apache Kafka,Advanced,10+,Kafka
Apache Iceberg,Advanced,10+,Iceberg
Data Architecture | Data Goverance | Data Security,Advanced,10+,Data
...
BigQuery,Intermediate,1+,Google
Google Cloud,Intermediate,1+,Google
React,Intermediate,1+,Google
...
HuggingFace,Intermediate,1+,HuggingFace
...
R,Intermediate,3+,R
Hive,Advanced,3+,Hive
Database Administration,Advanced,3+,Oracle
Legacy ETL Tools,Advanced,3+,Tools