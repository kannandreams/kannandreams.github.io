    ...
    <div className="vim-help animate-fade-in text-stone-300">
      {activeSection === "about" ? (
        <div className="bg-transparent p-3 rounded mb-3">
          ...
          <p className="mt-2">
          <u>Outside of Work:</u> More recently, I started <a href="https://engineersmeetai.substack.com/" target="_blank" rel="noopener noreferrer" aria-label="lovable" className="text-terminal-accent" >When Engineers meet AI</a> — a substack newsletter 
